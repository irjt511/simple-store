...
export const products: Product[] = [
  ...
  {
    id: 10,
    name: "دورة تصميم متجر إلكتروني",
    price: 99,
    image: "/images/course1.jpg",
    description: "دورة تعليمية شاملة تساعدك على تصميم متجر إلكتروني احترافي باستخدام منصة سلة، من الصفر حتى الإطلاق، تشمل تصميم الواجهة، إعداد الأقسام، طرق الدفع، والشحن.",
    categoryId: 4,
    features: [
      "شرح مفصل لإنشاء المتجر",
      "تطبيق عملي خطوة بخطوة",
      "ملفات مساعدة وتمارين",
      "شهادة حضور عند الانتهاء",
      "دعم فني وإجابة على الأسئلة",
      "تحديثات مستمرة للمحتوى"
    ],
    deliveryTime: "مدى الحياة (دخول دائم)",
    isSpecialOffer: true
  }
];
